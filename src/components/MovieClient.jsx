...
export default function MovieClient({ initialData }) {
    ...
    return (
        <div className="space-y-6">
            <div className="space-y-2">
                <h1 className="text-3xl font-bold tracking-tight">Movie Anime</h1>
            ...
            {animeList.length > 0 ? (
                ...
                <div className="flex min-h-[400px] items-center justify-center">
                    <p className="text-muted-foreground">No movie anime found.</p>
                </div>
            )}
        </div>
    );
