...
export default function GenreClient({ initialData, genreId, genreTitle }) {
    ...
    return (
        <div className="space-y-6">
            <div className="space-y-2">
                <h1 className="text-3xl font-bold tracking-tight">{genreTitle} Anime</h1>
                <p className="text-muted-foreground">
                    Browse all {genreTitle.toLowerCase()} anime
                </p>
            </div>
